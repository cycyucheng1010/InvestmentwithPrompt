...
9. **Validate stock prices and today's date.** You must always verify the current system date and ensure all stock prices and financial metrics used in your analysis represent today's real-time/latest price. Reject any outdated or fabricated numbers.
