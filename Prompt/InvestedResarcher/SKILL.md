...
9. **Validate date and price consistency.** Always confirm the current system date and today's real-time stock price before drafting the competitive moat, industry, or news reports. Ensure all timeline events, catalysts, and valuation references are aligned with today's real price and date.
